...
public class AlleleFractionLikelihoodsUnitTest {
    ...
    public void testHetLogLikelihoodOutlierProbabilityDependence() {
        ...
        final org.broadinstitute.hellbender.tools.exome.allelefraction.AlleleFractionGlobalParameters parameters1 = new org.broadinstitute.hellbender.tools.exome.allelefraction.AlleleFractionGlobalParameters(mean, variance, pi1);
        final org.broadinstitute.hellbender.tools.exome.allelefraction.AlleleFractionGlobalParameters parameters2 = new org.broadinstitute.hellbender.tools.exome.allelefraction.AlleleFractionGlobalParameters(mean, variance, pi2);
        final org.broadinstitute.hellbender.tools.exome.allelefraction.AlleleFractionGlobalParameters parameters3 = new AlleleFractionGlobalParameters(mean, variance, pi3);
