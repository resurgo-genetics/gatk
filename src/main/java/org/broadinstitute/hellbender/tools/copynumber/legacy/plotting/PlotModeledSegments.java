...
import org.broadinstitute.hellbender.tools.exome.plotting.PlotSegmentedCopyRatio;
...
public final class PlotModeledSegments extends CommandLineProgram {
    ...
    private void writeSegmentedAlleleFractionPlot(final String sampleName,
        ...
        executor.addScript(new Resource(ACNV_PLOTTING_R_SCRIPT, PlotModeledSegments.class));
