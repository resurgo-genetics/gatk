...
//     */
//    public CRAFModeller(final SegmentedGenome segmentedGenome,
...
//     * @param ctx                       JavaSparkContext, used for kernel density estimation in {@link PosteriorSummary}
//     */
//    public CRAFModeller(final SegmentedGenome segmentedGenome, final double minorAlleleFractionPriorAlpha, final AllelicPanelOfNormals allelicPoN,
//                        final int numSamplesCopyRatio, final int numBurnInCopyRatio,
//                        final int numSamplesAlleleFraction, final int numBurnInAlleleFraction,
//                        final JavaSparkContext ctx) {
...
//     */
//    public CRAFModeller(final SegmentedGenome segmentedGenome, final double minorAlleleFractionPriorAlpha,
//                        final int numSamplesCopyRatio, final int numBurnInCopyRatio,
//                        final int numSamplesAlleleFraction, final int numBurnInAlleleFraction,
//                        final JavaSparkContext ctx) {
...
//    }
//
//    public CRAFModeller(final SegmentedGenome segmentedGenome, final AllelicPanelOfNormals allelicPoN,
//                        final int numSamplesCopyRatio, final int numBurnInCopyRatio,
//                        final int numSamplesAlleleFraction, final int numBurnInAlleleFraction,
//                        final JavaSparkContext ctx) {
//        this(segmentedGenome, AlleleFractionModeller.MINOR_ALLELE_FRACTION_PRIOR_ALPHA_DEFAULT,
