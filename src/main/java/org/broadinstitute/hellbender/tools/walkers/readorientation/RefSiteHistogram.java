...
public class RefSiteHistogram {
    ...
    public void increment(final int depth){
        // we don't care about depth 0 so the 0th index will have depth 1
    ...
    public static List<RefSiteHistogram> readRefSiteHistograms(final File table) {
        final int num3Mers = 64; // 4^3 = 64
        List<RefSiteHistogram> histograms = new ArrayList<>(num3Mers);
